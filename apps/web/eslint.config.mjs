  ...
  ...nextTs,
  {
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        { selector: "JSXOpeningElement[name.name='select']", message: "Use a branded select instead of a native select." },
        ...
        { selector: "JSXOpeningElement[name.name='input'] > JSXAttribute[name.name='type'][value.value='checkbox']", message: "Use a branded checkbox instead of a native checkbox input." },
      ],
    },
  },

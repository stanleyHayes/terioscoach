        ...
        {services === null ? (
          ...
          <ul className="divide-y divide-border border-y border-border">
            {services.map((service, index) => (
              <li
                key={service.id}
                className="terios-service-row group grid gap-6 py-9 transition-[background-color,transform] duration-base hover:bg-eucalyptus-50/60 sm:grid-cols-[4rem_minmax(0,1fr)_auto] sm:px-5 lg:items-center lg:gap-10"
              >
                <span
                  aria-hidden="true"

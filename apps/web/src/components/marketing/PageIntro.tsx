...
export function PageIntro({ eyebrow, title, description }: { eyebrow: string; title: string; description: string }) {
  return (
    <header className="relative overflow-hidden border-b border-eucalyptus-800 bg-eucalyptus-900 text-sand-0">
      ...
      <div className="terios-intro relative mx-auto grid max-w-[1200px] gap-10 px-6 pb-20 pt-20 lg:grid-cols-[minmax(0,1fr)_18rem] lg:px-12 lg:pb-28 lg:pt-28">
        <div className="terios-intro-copy max-w-[52rem]">

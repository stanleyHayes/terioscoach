...
export const ADMIN_HELP_TOPICS: HelpTopic[] = [
  ...
  { path: "/payments", title: "Payments", goal: "Understand what was collected, pending, or refunded.", steps: ["Choose the reporting month.", "Review totals before opening individual transactions.", "Use Paystack alongside this page when investigating a discrepancy or refund."] },

...
export function EmptyState({
  ...
  return (
    <div
      className={`flex flex-col items-center rounded-lg border border-border bg-surface-raised px-6 text-center ${compact ? "py-8" : "py-16"} ${className}`}
    >
      <span
        aria-hidden="true"
        className="terios-empty-icon flex size-14 items-center justify-center rounded-full bg-surface-sunken text-ink-faint"
      >
        {icon}
      </span>
      ...
      <p className="mt-2 max-w-[46ch] text-sm leading-[1.55] text-ink-muted">
        {body}
      </p>
